...
const meta: ChatCompletionCreateParams.Function = {
  ...
  description: `
    Use this function to finds the list of comments for a github issue. Optionally
    provide a page number to paginate through the results. An issue_number must
    be provided.
  `,
  parameters: {
    type: "object",
